...
enum class ModFlags : SDL_Keymod {
  None = 0,
...
enum class ButtonFlags : SDL_MouseButtonFlags {
  None = 0,
...
enum class WheelDirection : std::underlying_type_t<SDL_MouseWheelDirection> {
...
constexpr Action action_from_sdl_keyboard_event(const SDL_KeyboardEvent *e) {
...
constexpr Action
action_from_sdl_mouse_button_event(const SDL_MouseButtonEvent *e) {
...
ENUM_CLASS_ENABLE_BITOPS(baphy::ButtonFlags);
